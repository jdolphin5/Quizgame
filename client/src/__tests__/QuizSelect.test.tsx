...
test('QuizSelect renders correctly', () => {
    ...
    const grid11 = screen.getByTestId('quizSelect-grid11');
    const typography1 = screen.getByTestId('quizSelect-dropdown-text');
    const grid12 = screen.getByTestId('quizSelect-grid12');
    const selectQuiz = screen.getByTestId('quizSelect-select');
    const grid21 = screen.getByTestId('quizSelect-grid21');
